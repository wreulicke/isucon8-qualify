...
mysql -uisucon torb -e 'ALTER TABLE reservations ADD INDEX reservations_event_id_canceled_at(`event_id`, `canceled_at`)'
mysql -uisucon torb -e 'ALTER TABLE events ADD INDEX events_id_public_fg(`id`, `public_fg`)'
